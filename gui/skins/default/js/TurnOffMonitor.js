...
/**
  * Logic for turnoff monitor management.
  *
  * For turnoff monitor there are two possible scenarios:
  ...
  *     2) an alarm arrives
  *     3) the monitor must turn on to make the user see the alarm
  *     4) if user doesn't take action, the monitor must turn off as soon
...
// time of last meaningful event, used to turn on the monitor
var last = 0
...
// calculates if timeout is elapsed for monitor turn on
