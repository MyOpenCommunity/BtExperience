...
Page {
    ...
    Component.onCompleted: {
        ...
        multimediaModel.append({"description": qsTr("web browser"), "target": "Browser.qml", "image": "images/multimedia/devices_card.jpg", "props": {"urlString": "http://www.google.it"}})
        multimediaModel.append({"description": qsTr("web link"), "target": "BrowserPage.qml", "image": "images/multimedia/devices_card.jpg", "props": {"containerUii": Container.IdMultimediaWebLink}})
        ...
        multimediaModel.append({"description": qsTr("ip radio"), "target": "BrowserIpRadioPage.qml", "image": "images/multimedia/devices_card.jpg", "props": {}})
